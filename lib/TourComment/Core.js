	...
	return new Promise((resolve) => {
		...
		var insert_data = (data, token) => {
			return new Promise((resolve_insert) => {
				var sql = "INSERT INTO `tour_comment_notifications` (`code`, `email`, `user_id`, `trx_booking_id`, `guide_tour_program_id`, `tour_id`) VALUES ('"+token+"', '"+data.email+"', "+data.user_id+", "+data.booking_id+", "+data.guide_tour_program_id+", "+data.tour_id+")";
				db.query(sql, (err) => {
					if (err) {
